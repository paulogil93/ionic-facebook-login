...
var HomePage = /** @class */ (function () {
    ...
    HomePage.prototype.FBLogin = function () {
        ...
        this.fb.login(["public_profile", "email"])
            ...
            _this.fb.api('me/?fields=id,email,name,birthday,picture.type(large)', ["public_profile", "email", "user_birthday"])
                .then(function (apiRes) {
                _this.userInfo = apiRes;
                _this.isUserLoggedIn = true;
            }).catch(function (apiErr) { return console.log(apiErr); });
        }).catch(function (loginErr) { return console.log(loginErr); });
    };
    HomePage.prototype.FBLogout = function () {
        var _this = this;
        this.fb.logout().then(function (logoutRes) {
            return _this.isUserLoggedIn = false;
        }).catch(function (logoutErr) {
            return console.log(logoutErr);
        });
    };
    HomePage = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["NavController"], _ionic_native_facebook_ngx__WEBPACK_IMPORTED_MODULE_3__["Facebook"]])
    ], HomePage);
    return HomePage;
}());
